...
@section('title', 'Download Application Form - ' . config('app.name'))

@section('content')
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 mb-8">Download Application Form</h1>

        @if($forms->isEmpty())
            <p class="text-gray-600">{{ settings('empty_application_forms', 'No application forms available right now.') }}</p>
        @else
            <ul class="space-y-4">
